            ...
            {findEmail.length == 0 ? 
                <div className="mx-[34px] flex flex-col gap-[10px]">
                    <div className="flex flex-col gap-[10px] mt-[25px] mb-[5px]">
                        <label className="pl-[3px] text-[#838687] text-[14px] font-bold" for="phoneNumber">
                            이름
                        </label>
                    ...
                    <div className="w-full grid items-center mt-[5px]">
                        ...
                        ${errors.length > 0 || name.length <= 0 || phoneNumber.length <= 0  || cn.length <= 0 || !isCNValid || !isPNValid ? "bg-[#D9D9D9] text-[#838687] cursor-default" : "bg-[#FFC421] text-white cursor-pointer"}`}
                            onClick={handleClick} disabled={errors.length > 0 || name.length <= 0 || phoneNumber.length <= 0  || cn.length <= 0 || !isCNValid || !isPNValid ? true : false}>
                            이메일 찾기
                        </button>
                    </div>
                </div>
