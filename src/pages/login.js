    ...
    <div>
      ...
      <div className="mx-[34px]">
        ...
        <div className="flex flex-col gap-[9px] mt-[40px]">
          <div className="flex flex-col gap-1">
            <label className="pl-[3px]" htmlFor="email">
              이메일
            </label>
            <input
              id="email"
          ...
          <div className="flex flex-col gap-1">
            <label className="pl-[3px]" htmlFor="password">
              비밀번호
            </label>
            <input
              id="password"
          ...
          <div className="w-full grid items-center">
            <button
              className={`mx-auto w-full h-[38px] mt-[5px] mb-[5px] py-1 rounded-md 
      ...
      <div className="flex justify-between mx-[34px] text-[#838687] text-[12px]">
        <div className="flex-none flex my-auto">
          <span
            className="flex-none text-[12px] underline cursor-pointer"
            onClick={() => {
              navigate("/signup", { state: { prevPage: prevPage } });
            }}
          >
            회원가입
          </span>
        ...
        <div className="flex-none flex gap-[2px] my-auto">
          <span
            ...
            onClick={() => {
              navigate("/findEmail", { state: { prevPage: prevPage } });
            }}
          >
            이메일 찾기
          </span>
          <hr
            ...
            className="h-[12px] mt-[4px] mx-[8px] border-[#D9D9D9] border-l-[0.1px]"
          />
          <span
            className="text-[12px] underline cursor-pointer"
            onClick={() => {
              navigate("/findPW", { state: { prevPage: prevPage } });
            }}
          >
            비밀번호 재설정
          </span>
