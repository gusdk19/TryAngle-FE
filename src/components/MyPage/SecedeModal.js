            ...
            <>
                ...
                <div className="inner-modal">
                    <div className="modal-sq w-full h-full">
                        {/* Title */}
                        <h2 className="text-[16px] text-[#6e6053] font-semibold text-center pt-[1px]">탈퇴하기</h2>
        ...
        <>
          ...
          <div className="inner-modal">
            <div className="modal-sq w-full h-full">
                ...
                {/* Close Button */}
                <button className="close-btn" onClick={()=>{onClose(false); if(success){logout();};}}>
                    <IoMdClose className="text-[#6e6053] w-[25px] h-[25px]" color="#6e6053"/>
                </button>
                ...
                {error && <div className="mb-[18px] px-[5px] text-[12px] text-center text-[red]">
                    ※ {error}
                </div>}
