...
export default function Footer({page}){
    ...
    // Navigation items data
      const navigationItems = [
        ...
        { icon: page == "myChalleng" ? <PiTriangleDashedFill className="w-[33px] h-[33px] font-thin mb-[3px] mr-[35px]" />
    ...
    return(
        <footer className="absolute w-full h-[70px] bottom-0 left-0 bg-white pl-4 pt-1">
