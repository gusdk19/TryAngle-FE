    ...
    const handleReport = async()=>{
        ...
        try {
            ...
            if(data.isSuccess){
                ...
                setReason("");
                setErrors((prev) => ([...prev, "신고에 실패했습니다. 다시 시도해주십시오."]));
            }
        } catch (error) {
                ...
                <div className="inner-modal">
                    <div className="modal-sq w-full h-full">
                        ...
                        <div className="flex flex-col gap-2 my-[10px] px-[5px] pt-[12px] text-center ">
                            <p className="text-[16px] text-[red] font-semibold">신고가 완료되었습니다.</p>
                        </div>
        ...
        <>
          ...
          <div className="inner-modal">
            <div className="modal-sq w-full h-full">
                ...
                {/* 신고사유 입력 */}
                <div className={`mx-auto mt-[8px] ${errors.length > 0 ? "mb-[10px]" : "mb-[20px]"} flex flex-col justify-between gap-2`}>
                    <label htmlFor="withdrawal" className="ml-[2px] mt-[2.5px] flex-none text-[#6e6053]">
                        <span className={`text-[#6E6053] font-bold text-[15px]`}>신고 이유</span>
                    </label>
                    <textarea
                        id="withdrawal"
                ...
                <div className="w-full grid items-center">
                    ...
                    ${reason.length > 0 ? "bg-[#FFC421] cursor-pointer" : "bg-[#d9d9d9] cursor-default"}`}
