...
export default function NotificationItem({ notification, onClick }) {
  ...
  return (
    <div
      onClick={() => onClick(notification.notification_id)}
      ...
      <div className="flex flex-col justify-center ml-[12px] mt-[14px] leading-[24px] text-[14px] text-[#4A483F]">
        {notification.notification_type === 'FOLLOW' && (
          <>
            ...
            <p>
              <span className="font-bold">{notification.nickname || '다연'}</span> 
              님이 친구신청을 보냈습니다. 
            </p>
          </>
        )}
        {notification.notification_type === 'CHALLENGE_INVITE' && (
          <>
            ...
            <p>
              ...
              에 초대했습니다.
              < br />
              (초대코드: {notification.challenge_id})
            </p>
          </>
        )}
      </div>
