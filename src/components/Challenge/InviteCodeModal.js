  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full bg-white bg-opacity-80 flex justify-center items-center z-50">
      <div className="bg-[#FDF8ED] p-10 rounded w-[364px] h-[400px] relative">
        <button
          onClick={onClose}
          className=" text-[#6E6053] absolute top-3 right-3 w-8 h-8 text-2xl z-10 flex items-center justify-center hover:text-black"
        >
          ×
        </button>
        <h2 className=" text-[#6E6053] text-center text-[15px] font-bold mb-6">
          초대 코드
        </h2>
