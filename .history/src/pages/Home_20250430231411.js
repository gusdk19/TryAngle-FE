    ...
    <div className="bg-white flex flex-row justify-center w-full">
      ...
      <div className="bg-white w-[393px] h-[852px] relative">
        ...
        <div className="flex justify-between items-center px-4 mt-4">
          ...
          <button className="bg-yellow-400 text-white text-xl w-8 h-8 rounded-full flex items-center justify-center shadow hover:bg-yellow-500"
    //</div>onClick={() => navigate('/challenge/add')}>
