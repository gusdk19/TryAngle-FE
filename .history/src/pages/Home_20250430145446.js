...
const Home = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-200">
      {/* 모바일 프레임 */}
      <div className="relative w-[390px] h-[844px] bg-white overflow-hidden rounded-xl shadow-lg flex flex-col">
        <Header />
        ...
        {/* + 버튼 */}
        <button className="absolute bottom-20 right-4 bg-yellow-400 w-12 h-12 rounded-full text-white text-2xl shadow-md hover:bg-yellow-500 z-20">
          +
        </button>
